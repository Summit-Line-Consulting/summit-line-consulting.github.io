...
After you're satisfied with your changes, but before committing changes and publishing, use the `quarto_render()` command below or the `Render` button in the toolbar to check that everything works (one more time).
...
You can also run this command in the terminal which might be better as it gives more interactive output.
